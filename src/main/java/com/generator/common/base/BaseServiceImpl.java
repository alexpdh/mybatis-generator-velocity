...
import com.generator.common.db.DataSourceEnum;
import com.generator.common.db.DynamicDataSource;
import com.generator.common.util.SpringContextUtil;
 ...
 * 实现BaseService抽象类
 */
public abstract class BaseServiceImpl<Mapper, Record, Example> implements
		BaseService<Record, Example> {
	...
	public int countByExample(Example example) {
		try {
			...
			Method countByExample = mapper.getClass()
